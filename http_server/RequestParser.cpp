...
RequestParser::RequestParser() : finished(false), fvpairs()
{
	num = 0;
...
size_t RequestParser::parser_execute(const char *buf, size_t recved)     /* recved is the length of the content in buf */
{
	++num;
